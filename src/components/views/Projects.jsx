                            ...
                            >
                                <div className="relative h-48 bg-[#171717]">
                                    ...
                                    <div className="absolute inset-0 bg-black bg-opacity-60 opacity-0 hover:opacity-100 flex items-center justify-center gap-4 transition-opacity">
                                        <a href={project.demo_link} target='_blank' className="px-4 py-2 border border-white text-white rounded hover:bg-white hover:text-gray-900 transition-colors cursor-pointer">{t('projects.button.btn_demo')}</a>
                                        <a href={project.code_link} target='_blank' className="px-4 py-2 border border-white text-white rounded hover:bg-white hover:text-gray-900 transition-colors cursor-pointer">{t('projects.button.btn_code')}</a>
                                    </div>
                                </div>
                                <div className="p-6">
