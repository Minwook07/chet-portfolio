                ...
                <div className="grid md:grid-cols-2 gap-10">
                    <div>
                        <div className="mb-10">
                            ...
                            <p className="text-gray-300 mb-8">Fill out the form or reach out through the provided contact details.</p>
                            <div className="flex items-center mb-4">
                                ...
                                <span>
                                    <a href="mailto:mith.chett@gmail.com"
                        ...
                        <div className="flex gap-4">
                            <a href="https://github.com/Minwook07" target='_blank' className="w-10 h-10 bg-[#1E1E1E] rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
                                </svg>
                            </a>
                            <a href="https://www.linkedin.com/in/mith-chet-ab56b5295/" target='_blank' className="w-10 h-10 bg-[#1E1E1E] rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div>
                        <form className="border bg-[#1E1E1E] border-[#1E1E1E] rounded-xl p-8">
                            <div className="mb-4">
                            ...
                            <button className="w-full py-3 bg-orange-500 text-white rounded-lg font-medium hover:bg-orange-600 transition-colors cursor-pointer">
                                Send Message
                            </button>
                        </form>
                    </div>
